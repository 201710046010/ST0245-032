...
public class Bloques{
    public static int numeroBloques; 
    ...
    public static void main (String[] args) throws IOException{
        ...
        numeroBloques = Integer.parseInt(Input.readLine());
        ...
        linea = "";
        while (!(linea=Input.readLine()).equals("quit")){
    ...
    public static void MoveOnto(int primero,int segundo){
        limpiar(segundo);
        MoveOver(primero,segundo);
    }

    public static void MoveOver(int primero, int segundo) {   
        limpiar(primero);
